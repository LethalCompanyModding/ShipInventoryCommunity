...
public class BadItem : PhysicsProp
{
    ...
    private void CheckForItem()
    {
        ...
        Helpers.Logger.Debug($"The item '{ID}' was found! Replacing the bad item with it...");
        ...
        Helpers.Logger.Debug("The replacement was spawned and the bad item was despawned!");
    }
